...
export const resolveChatRole = (preferredRole) => {
  ...
  if (getModuleToken('admin') || localStorage.getItem('auth_admin') || localStorage.getItem('adminToken')) {
    return 'admin';
  }
...
export const resolveChatToken = (preferredRole) => {
  ...
  const adminToken = getModuleToken('admin') || localStorage.getItem('auth_admin') || localStorage.getItem('adminToken');
...
export const getChatSession = (preferredRole) => {
  ...
  const adminInfo = getCurrentUser('admin') || readJsonLocalStorage('adminInfo');
