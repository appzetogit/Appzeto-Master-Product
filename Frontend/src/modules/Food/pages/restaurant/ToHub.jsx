...
export default function ToHub() {
  ...
  const cardDefinitions = {
    ...
    "orders-placed": {
      title: "Orders placed",
      metrics: [{ name: "Total orders", definition: "All orders received" }],
    },
    "orders-by-customer": {
  ...
  const [impressionsCustomerView, setImpressionsCustomerView] =
    useState("affinity");
  const [menuOpensCustomerView, setMenuOpensCustomerView] =
    useState("affinity");
  const [ordersPlacedCustomerView, setOrdersPlacedCustomerView] =
    useState("affinity");
  ...
  const [adImpressionsCustomerView, setAdImpressionsCustomerView] =
    useState("affinity");
  ...
  const fetchOrdersAndUpdateChart = useCallback(
    async (rangeId) => {
      try {
        ...
        debugLog(`?? Fetched ${allOrders.length} orders for date range:`, {
        ...
        if (allOrders.length > 0) {
          ...
          const mealtimeData = calculateMealtimeData(
            allOrders,
            startDate,
            endDate,
          );

          debugLog("?? Chart data calculated:", {
            totalSales: newTotalSales,
            totalOrders: newTotalOrders,
          ...
          // No orders found
          debugLog("?? No orders found for the selected date range");
          setChartData([
            { hour: "12am", orders: 0, sales: 0 },
            { hour: "4am", orders: 0, sales: 0 },
            { hour: "8am", orders: 0, sales: 0 },
        ...
        if (error.response?.status !== 401) {
          debugError("Error fetching orders for chart:", error);
        }
      ...
      <div className="px-4">
        <div className="bg-white rounded-lg space-y-4">
          <div className="flex items-center justify-between p-4">
            ...
            <span className="text-xs text-green-700 bg-green-100 px-3 rounded-full">
              Live
            </span>
          </div>
        ...
        <div className="bg-white rounded-lg p-4 space-y-4 relative">
          {isDateLoading && (
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              <div className="relative text-sm font-semibold text-gray-700 animate-pulse">
                Refreshing...
              </div>
            </div>
          )}
              ...
              <button
                onClick={() =>
                  setShowLearnMoreButton(
                    showLearnMoreButton === "sales" ? null : "sales",
                  )
                }
          ...
          {[
            ...
            <div
              ...
              className={
                idx < 2
                  ? "pb-3 border-b border-dashed border-gray-200 space-y-2"
                  : "space-y-2"
              }>
          ...
          <div className="pt-2">
            <div className="flex items-center justify-center gap-4 text-xs text-gray-600">
              <span className="flex items-center gap-2">
                <span className="w-3 h-0.5 bg-gray-900 inline-block"></span>
                Yesterday
              </span>
              <span className="flex items-center gap-2">
                <span className="w-3 h-0.5 bg-gray-400 inline-block"></span>Day
                before yesterday
              </span>
            </div>
            <button
            ...
            <div className="relative">
              ...
              {showLearnMoreButton === "orders-by-mealtime-myfeed" && (
                <motion.div
                  ...
                  <button
                    onClick={(e) =>
                      handleLearnMoreClick("orders-by-mealtime", e)
                    }
                    className="bg-white border border-gray-200 shadow-lg rounded-lg px-4 py-2 text-sm font-medium text-gray-900 hover:bg-gray-50 whitespace-nowrap">
                    Learn more
                  </button>
          ...
          <div className="flex-1 flex items-center justify-center px-4 pb-6">
            <div className="w-full max-w-5xl aspect-video bg-black rounded-xl overflow-hidden shadow-2xl border border-white/10">
              <video
                ...
                playsInline>
                <source
                  src="https://assets.mixkit.co/videos/preview/mixkit-cooking-a-vegetable-stir-fry-in-a-wok-4782-large.mp4"
                  type="video/mp4"
                />
              </video>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="relative">
                <button
                  onClick={() =>
                    setShowLearnMoreButton(
                      showLearnMoreButton === "sales-tab" ? null : "sales-tab",
                    )
                  }
                  className="p-2 rounded-full hover:bg-gray-100">
                  <MoreVertical className="w-5 h-5 text-gray-600" />
              ...
              <div className="relative">
                ...
                {showLearnMoreButton === "avg-order-value" && (
                  <motion.div
                    ...
                    <button
                      onClick={(e) =>
                        handleLearnMoreClick("avg-order-value", e)
                      }
                      className="bg-white border border-gray-200 shadow-lg rounded-lg px-4 py-2 text-sm font-medium text-gray-900 hover:bg-gray-50 whitespace-nowrap">
                      Learn more
                    </button>
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          {activeTopTab === "my-feed" ? (
            ...
            <EmptyTab
              label={topTabs.find((t) => t.id === activeTopTab)?.label || "Tab"}
            />
          )}
        </motion.div>
      </AnimatePresence>
