...
export default function SupportTickets() {
  ...
  const update = async (id, patch) => {
    try {
      await supportAPI.updateSupportTicketAdmin(id, patch)
      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 mb-6 space-y-4">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h1 className="text-lg font-semibold text-slate-900">User Support Tickets</h1>
              <p className="text-sm text-slate-500 mt-1">Review and respond to support tickets raised by users.</p>
            </div>
          ...
          <div className="overflow-x-auto">
            ...
            <tbody className="divide-y">
              {loading ? (
                ...
                <tr><td colSpan={8} className="px-4 py-6 text-center text-slate-500">No tickets</td></tr>
              ) : tickets.map((t) => (
                <tr key={t._id}>
