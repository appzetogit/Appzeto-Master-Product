...
// The hotelRoutes are likely mounted at /api/v1/hotel or /api/v1/partners.
// If standard 'userService' calls /api/v1/users/notifications, that might not work if 'protect' middleware expects 'user' role unless userController handles both.
...
// Usually `/api/v1/hotels` or `/api/v1/partners`.

// Let's assume for now I need a `hotelService` or `partnerService` to call `/api/v1/hotels/notifications`.
