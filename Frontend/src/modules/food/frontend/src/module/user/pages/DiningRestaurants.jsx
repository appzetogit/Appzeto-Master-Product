...
import diningBanner from "@food/assets/diningrestaurantbanner.png"
...
export default function DiningRestaurants() {
  ...
  return (
    <AnimatedPage className="bg-white" style={{ minHeight: '100vh', paddingBottom: '80px', overflow: 'visible' }}>
      ...
      <div className="relative w-full overflow-hidden min-h-[27vh]">
        ...
        <nav className="relative z-20 w-full px-3 sm:px-6 lg:px-8 py-3 sm:py-4 backdrop-blur-sm">
        ...
        <div className="mb-6">
          <div className="relative">
            <Input
              ...
              className="w-full h-12 sm:h-14 pl-12 sm:pl-14 pr-12 sm:pr-14 rounded-xl border-2 border-gray-200 focus:border-green-600 bg-white shadow-sm text-base sm:text-lg"
            />
