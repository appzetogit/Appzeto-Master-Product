...
// Import banner
import giftCardBanner from "@food/assets/giftcardpagebanner.png"
          ...
          <Card className="border border-gray-100 shadow-sm">
            <CardContent className="p-4 space-y-4">
              ...
              <div className="flex items-center gap-1 pt-1">
                ...
                <Link to="/food/user/gift-card/redeem" className="text-green-700 text-sm font-medium underline underline-offset-2 decoration-dashed hover:text-green-800">
                  Redeem now
                </Link>
              </div>
            </CardContent>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 p-4 shadow-lg">
        <Button 
          ...
          onClick={() => {
            ...
            navigate('/food/user/gift-card/checkout', { 
              state: { 
