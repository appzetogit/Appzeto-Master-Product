        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1">
              Import categories in bulk using Excel files
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-start gap-6">
          <div className="flex-1">
            ...
            <div className="space-y-2 text-sm text-slate-600 ml-14 mb-6">
              ...
              <p>• For parent category position will 0 and for sub category it will be 1</p>
              <p>• By default status will be 1 please input the right ids</p>
              <p>• For Priority set 0 for Normal 1 for Medium and 2 for high</p>
              <p>• For a category parent id will be empty for sub category it will be the category id</p>
            </div>
            <div className="ml-14">
        ...
        <div className="flex items-start gap-6">
          <div className="flex-1">
            ...
            <div className="space-y-2 text-sm text-slate-600 ml-14">
              ...
              <p>• You can upload your category images in category folder from gallery and copy image's path.</p>
            </div>
          </div>
