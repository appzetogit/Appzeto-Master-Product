    ...
    <div className="p-4 lg:p-6 bg-slate-50 min-h-screen">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-900">Export Categories</h1>
            <p className="text-sm text-slate-500 mt-1">
              Export category data in bulk using filters
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 mb-6">
        ...
        <div className="ml-14">
          ...
          >
            ...
            <option value="with-subcategories">Categories with Subcategories</option>
            <option value="without-subcategories">Categories without Subcategories</option>
          </select>
        </div>
      </div>
