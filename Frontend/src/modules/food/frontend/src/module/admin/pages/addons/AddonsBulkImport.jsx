...
import { FileSpreadsheet, Download, Upload, FileCheck, ArrowRight, RefreshCw } from "lucide-react"

export default function AddonsBulkImport() {
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1">
              Import addons in bulk using Excel files
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-start gap-6">
          <div className="flex-1">
            ...
            <div className="space-y-2 text-sm text-slate-600 ml-14 mb-6">
              ...
              <p>• Select the correct addon category for each addon</p>
              <p>• By default status will be 1 please input the right ids</p>
              <p>• Enter price in decimal format (e.g., 2.50)</p>
              <p>• Category ID must match existing addon category</p>
            </div>
            <div className="ml-14">
