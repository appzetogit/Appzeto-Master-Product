...
import growCustomerBaseIcon from "@food/assets/hub/icons/growyourcustomerbase.png"
import increaseOrderValueIcon from "@food/assets/hub/icons/increaseyourordervalue.png"
import getMealtimeOrdersIcon from "@food/assets/hub/icons/getmoremeantimeorders.png"
import delightCustomersIcon from "@food/assets/hub/icons/deliteyourcustomer.png"
      ...
      <div className="sticky top-0 z-40 bg-white border-b border-gray-200">
        <div className="px-4 py-3">
          <div className="flex items-center gap-3">
            <button
              onClick={() => navigate("/food/restaurant/hub-growth")}
