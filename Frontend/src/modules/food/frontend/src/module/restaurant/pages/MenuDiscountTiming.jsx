...
export default function MenuDiscountTiming() {
  ...
  const getBackPath = () => {
    if (discountType === "percentage-menu") return "/food/restaurant/hub-growth/create-offers/delight-customers/percentage"
    if (discountType === "flat-price-menu") return "/food/restaurant/hub-growth/create-offers/delight-customers/flat-price"
    if (discountType === "bogo-menu") return "/food/restaurant/hub-growth/create-offers/delight-customers/bogo"
    return "/food/restaurant/hub-growth/create-offers/delight-customers"
  }

  const getPreviewPath = () => {
    if (discountType === "percentage-menu") return "/food/restaurant/hub-growth/create-offers/delight-customers/percentage/preview"
    if (discountType === "flat-price-menu") return "/food/restaurant/hub-growth/create-offers/delight-customers/flat-price/preview"
    if (discountType === "bogo-menu") return "/food/restaurant/hub-growth/create-offers/delight-customers/bogo/preview"
    return "/food/restaurant/hub-growth/create-offers/delight-customers/freebies/preview"
  }
