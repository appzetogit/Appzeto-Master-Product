...
export default function MenuOverlay({ showMenu, setShowMenu }) {
  ...
  const getMenuOptions = () => {
    const baseOptions = [
      { id: 3, name: "Edit Profile", icon: User, route: "/food/restaurant/profile/edit" },
      { id: 4, name: "All Food", icon: Utensils, route: "/food/restaurant/food/all" },
      { id: 5, name: "Campaign", icon: Megaphone, route: "/food/restaurant/campaign" },
      ...
      { id: 8, name: "Addons", icon: Plus, route: "/food/restaurant/addons" },
      ...
      { id: 13, name: "Reports", icon: FileText, route: "/food/restaurant/reports" },
      { id: 14, name: "Wallet Method", icon: Settings, route: "/food/restaurant/wallet" },
      { id: 15, name: "Language", icon: Globe, route: "/food/restaurant/language" },
