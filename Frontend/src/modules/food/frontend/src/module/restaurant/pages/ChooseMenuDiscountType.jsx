...
import freebiesIcon from "@food/assets/hub/icons/delite your customers/freebies.png"
import percentageDiscountIcon from "@food/assets/hub/icons/delite your customers/percentagediscount.png"
import flatPriceIcon from "@food/assets/hub/icons/delite your customers/flatprice.png"
import bogoIcon from "@food/assets/hub/icons/delite your customers/bogo.png"
          ...
          {menuDiscountTypes.map((type, index) => (
            <motion.div
              ...
              onClick={() => {
                ...
                if (type.id === "freebies") {
                  navigate("/food/restaurant/hub-growth/create-offers/delight-customers/freebies")
                } else if (type.id === "percentage") {
                  navigate("/food/restaurant/hub-growth/create-offers/delight-customers/percentage")
                } else if (type.id === "flat-price") {
                  navigate("/food/restaurant/hub-growth/create-offers/delight-customers/flat-price")
                } else if (type.id === "bogo") {
                  navigate("/food/restaurant/hub-growth/create-offers/delight-customers/bogo")
                } else {
