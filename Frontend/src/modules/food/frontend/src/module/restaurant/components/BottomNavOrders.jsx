...
const ordersTabs = [
  { id: "orders", label: "Orders", icon: FileText, route: "/food/restaurant" },
  { id: "inventory", label: "Inventory", icon: Package, route: "/food/restaurant/inventory" },
  { id: "feedback", label: "Feedback", icon: MessageSquare, route: "/food/restaurant/feedback" },
  { id: "explore", label: "Explore", icon: Compass, route: "/food/restaurant/explore" },
]

const hubTabs = [
  { id: "hub", label: "  Hub  ", icon: Building2, route: "/food/restaurant/to-hub" },
  { id: "growth", label: "Growth", icon: TrendingUp, route: "/food/restaurant/hub-growth" },
  { id: "menu", label: "Menu", icon: Utensils, route: "/food/restaurant/hub-menu" },
  { id: "finance", label: "Finance", icon: Wallet, route: "/food/restaurant/hub-finance" },
]
...
export default function BottomNavOrders() {
  ...
  const isHubMode = useMemo(() => {
    return pathname.startsWith("/food/restaurant/hub") || pathname.startsWith("/food/restaurant/to-hub")
  }, [pathname])
  ...
  const handleToggleMode = () => {
    ...
    requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        ...
        setTimeout(() => {
          navigate(isHubMode ? "/food/restaurant" : "/food/restaurant/to-hub")
