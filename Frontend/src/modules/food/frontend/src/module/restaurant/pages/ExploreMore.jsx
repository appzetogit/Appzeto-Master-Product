...
export default function ExploreMore() {
  ...
  const handleLogoutAllDevices = () => {
    navigate("/food/restaurant/welcome")
  ...
  const manageOutletItems = [
    ...
    { id: 3, label: "Phone numbers", icon: Phone, route: "/food/restaurant/phone" },
    { id: 4, label: "Manage staff", icon: Users, route: "/food/restaurant/contact-details" },
  ]

  const settingsItems = [
    { id: 3, label: "Delivery settings", icon: Truck, route: "/food/restaurant/delivery-settings" },
    { id: 4, label: "Rush hour", icon: Hourglass, route: "/food/restaurant/rush-hour", badge: rushHourStatus ? null : "OFF" },
    { id: 5, label: "Schedule off", icon: Clock, route: "/food/restaurant/schedule-off" },
  ]
  ...
  const helpItems = [
    { id: 1, label: "Help centre", icon: HelpCircle, route: "/food/restaurant/help-centre" },
    { id: 3, label: "Share your feedback", icon: Edit, route: "/food/restaurant/Share-Feedback" },
  ]
        ...
        >
          <Card className="bg-white border-gray-200 py-3 mb-6 rounded-lg shadow-0">
            <CardContent className="px-4">
              <button
                onClick={() => navigate("/food/restaurant/switch-outlet")}
