  ...
  const settingsSections = [
    {
      ...
      title: "Account",
      items: [
        { id: "profile", label: "Edit Profile", icon: User, route: "/food/restaurant/profile/edit" },
        ...
        { id: "privacy", label: "Privacy & Security", icon: Shield, route: "/food/restaurant/privacy" },
      ]
    },
    {
      id: "preferences",
      title: "Preferences",
      items: [
        { id: "language", label: "Language", icon: Globe, route: "/food/restaurant/language", value: "English" },
    ...
    },
    {
      ...
      items: [
        { id: "conversation", label: "Conversation", icon: MessageSquare, route: "/food/restaurant/conversation" },
        { id: "terms", label: "Terms & Conditions", icon: FileText, route: "/food/restaurant/terms" },
        { id: "privacy-policy", label: "Privacy Policy", icon: Shield, route: "/food/restaurant/privacy" },
        { id: "about", label: "About", icon: Info, route: "/food/restaurant/about" },
      ]
    },
    {
      id: "actions",
